...
<h1 id="rozšíření-fronty--úloh-job-queue---nastavení">Rozšíření fronty  úloh (Job Queue) - Nastavení</h1>

<p><strong>See also</strong></p>
<p><a href="job-queue-extension.html">Rozšíření fronty  úloh (Job Queue)</a><br>
          ...
          <div class="hidden-sm col-md-2" role="complementary">
            <div class="sideaffix">
              <div class="contribution">
                <ul class="nav">
                  <li>
                    <a href="https://github.com/AutoContCZ/AC-IB-dynamics365smb-docs/blob/master/business-central/ProductivityPack/job-queue-extension-setup.md/#L1" class="contribution-link">Improve this document</a>
                  </li>
                </ul>
              </div>
